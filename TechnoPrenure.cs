...
{
    internal class TechnoPrenure : Person, IEntrepreneur
    {
        ...
        public TechnoPrenure(string id, string name, string city, int age,
        ...
        public void DisplayEntroprenurDetails()
        {
            ...
            base.DisplayPersonInfo(); // Call the base class method to display person details
        }
